                                        ...
                                        @foreach ($periods as $period)
                                            <tr>
                                                ...
                                                @else
                                                    <td>ganjil</td>
                                                @endif
                                                <td>{{ date('d M Y | H:i:s', ($period->start_date_vote + (60*60*7) )); }}</td>
                                                <td>{{ date('d M Y | H:i:s', ($period->end_date_vote + (60*60*7) )); }}</td>
                                                <td>{{ date('d M Y | H:i:s', ($period->start_date_submission + (60*60*7) )); }}</td>
                                                <td>{{ date('d M Y | H:i:s', ($period->end_date_submission + (60*60*7) )); }}</td>
