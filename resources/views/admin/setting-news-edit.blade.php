                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-4">
                                            ...
                                            <input id="start-date-news" name="start-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="{{ date('Y-m-d H:i',$collections->start_date + (60*60*7)) }}" placeholder="Select Date..">
                                        </div>

                                        <div class="col-6 mt-4">
                                            <label for="end-date-news" class="form-label">End Date News</label>
                                            <input id="end-date-news" name="end-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="{{ date('Y-m-d H:i',$collections->end_date + (60*60*7)) }}" placeholder="Select Date..">
                                        </div>
