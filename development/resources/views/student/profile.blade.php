                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control mb-3" id="name" name="name" placeholder="Type name team" value="{{$collection->name}}">
                                                        ...
                                                        <div class="form-group">
                                                            <a href="./app-calendar.html" aria-expanded="false" class="dropdown-toggle">
                                                                <div class="d-flex pt-3">
                                                                    <svg class="pt-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>
                                                                    <label class="ms-2">localhost/study-wars</label>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
