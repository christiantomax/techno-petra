...
<body class="">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="id" class="form-control" id="id" value=<?php echo e($period->id); ?>>
                                            <input type="number" name="year" class="form-control" id="year" value=<?php echo e($period->year); ?>>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-6 mt-4">
                                            ...
                                            <input id="start-date-vote" name="start-date-vote" value="<?php echo e(gmdate("Y-m-d", $period->start_date_vote)); ?> <?php echo e(gmdate("H:i", $period->start_date_vote)); ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                        </div>
                                        <div class="col-6  mt-4">
                                            <label for="end-date-vote" class="form-label">End Date Vote</label>
                                            <input id="end-date-vote" name="end-date-vote" value="<?php echo e(gmdate("Y-m-d", $period->end_date_vote)); ?> <?php echo e(gmdate("H:i", $period->end_date_vote)); ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                        </div>
                                        <div class="col-6 mt-4">
                                            <label for="start-date-submission" class="form-label">Start Date Submission</label>
                                            <input id="start-date-submission" name="start-date-submission" value="<?php echo e(gmdate("Y-m-d", $period->start_date_submission)); ?> <?php echo e(gmdate("H:i", $period->start_date_submission)); ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                        </div>
                                        <div class="col-6 mt-4">
                                            <label for="end-date-submission" class="form-label">End Date Submission</label>
                                            <input id="end-date-submission" name="end-date-submission" value="<?php echo e(gmdate("Y-m-d", $period->end_date_submission)); ?> <?php echo e(gmdate("H:i", $period->end_date_submission)); ?>" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Select Date..">
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo e(route('ajaxPeriodEdit.post')); ?>",
            data:{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-period-edit.blade.php ENDPATH**/ ?>