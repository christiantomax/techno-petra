...
<head>
    ...
    <title>Techno | Create News</title>
...
<body class="">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mt-4">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Product Name" value="Nike Shoes Red">
                                        </div>
                                        ...
                                        <div class="col-6 mt-4">
                                            ...
                                            <input id="start-date-news" name="start-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="2022-07-07 12:00" placeholder="Select Date..">
                                        </div>

                                        <div class="col-6 mt-4">
                                            <label for="end-date-news" class="form-label">End Date News</label>
                                            <input id="end-date-news" name="end-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="2022-07-07 12:00" placeholder="Select Date..">
                                        </div>
    ...
    <script>
        ...
        var f2 = flatpickr(document.getElementById('end-date-news'), {
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });
    ...
    <script>
        $(".btn-submit").click(function(e){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxNewsCreate.post')); ?>",
                data:{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-news-create.blade.php ENDPATH**/ ?>