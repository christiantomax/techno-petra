            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo e(url('src/assets/img/1x1/us.svg')); ?>" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo e(url('src/assets/img/1x1/us.svg')); ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo e(url('src/assets/img/1x1/tr.svg')); ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Turkish</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo e(url('src/assets/img/1x1/br.svg')); ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Portuguese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo e(url('src/assets/img/1x1/in.svg')); ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Hindi</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?php echo e(url('src/assets/img/1x1/de.svg')); ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                    </div>
                </li>
                        ...
                        <div class="notification-scroll">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    <img src="<?php echo e(url('src/assets/img/profile-16.jpeg')); ?>" class="img-fluid me-2" alt="avatar">
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    <img src="<?php echo e(url('src/assets/img/profile-15.jpeg')); ?>" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    <img src="<?php echo e(url('src/assets/img/profile-21.jpeg')); ?>" class="img-fluid me-2" alt="avatar">
                                    <div class="media-body">
                                        <div class="data-info">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="<?php echo e(url('src/assets/img/profile-30.png')); ?>" class="rounded-circle">
                            </div>
                        </div>
                    </a>
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="./index.html">
                                <img src="<?php echo e(url('src/assets/img/logo.svg')); ?>" class="navbar-logo" alt="logo">
                            </a>
                        </div>
                                ...
                                <table id="zero-config" class="table table-striped dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($collection->year); ?> |
                                                <?php if($collection->semester == 0): ?>
                                                    Genap
                                                <?php else: ?>
                                                    Ganjil
                                                <?php endif; ?>
                                                ...
                                                <td><?php echo e($collection->nrp_leader); ?></td>
                                                <td><?php echo e($collection->member); ?></td>
                                                <td>
                                                    <?php if($collection->categories): ?>
                                                        <?php echo e(rtrim($collection->categories, ", ")); ?>
                                                ...
                                                <?php endif; ?>
                                                <td>
                                                    <a href="<?php echo e(url('admin/team/edit')); ?>/<?php echo e($collection->id); ?>">
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-team-leader-list.blade.php ENDPATH**/ ?>