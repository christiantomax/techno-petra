...
<body class="">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="id" type="hidden" name='id' class="form-control" value='<?php echo e($data['collections']->id); ?>'>
                                            <input id="nrp" type="text" name='nrp' class="form-control" value='<?php echo e($data['collections']->nrp_leader); ?>'>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="period" class="form-label">Period</label>
                                            <select id="period" class="form-select" name="period">
                                                <?php $__currentLoopData = $data['periods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value=<?php echo e($collection->id); ?>

                                                        <?php if($collection->id == $data['collections']->id_period): ?>
                                                            <?php echo e("selected"); ?>
    ...
    <script type="text/javascript">
        $(".btn-submit").click(function(e){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxTeamEdit.post')); ?>",
                data:{
                ...
                success:function(data){
                    if(data.status == 200){
                        swal({
                            ...
                            function(isConfirm) {
                            if (isConfirm) {
                                window.location.href = "<?php echo e(route('team.list')); ?>";
                            }
                        });
                    }else{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-team-leader-edit.blade.php ENDPATH**/ ?>