...
<head>
    ...
    <title>Techno | <?php echo e($collections[0]->name); ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/src/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/src/glightbox/glightbox.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/src/splide/splide.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/light/components/tabs.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/light/apps/ecommerce-details.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/dark/components/tabs.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/dark/apps/ecommerce-details.css')); ?>">
...
<body class="layout-boxed">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e($collections[0]->name); ?></li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                                        ...
                                        <div id="main-slider" class="splide">
                                            <div class="splide__track">
                                                    <ul class="splide__list">
                                                        <?php if(isset($collections[0]->thumbnail)): ?>
                                                        <li class="splide__slide">
                                                            <a href="<?php echo e($collections[0]->thumbnail); ?>" class="glightbox">
                                                                <img alt="project-preview" style="object-fit: contain;" class="img-thumbnail" src="<?php echo e($collections[0]->thumbnail); ?>">
                                                            </a>
                                                        </li>
                                                        <?php endif; ?>
                                                        <?php
                                            ...
                                            <div class="splide__track">
                                                    <ul class="splide__list">
                                                        <?php if(isset($collections[0]->thumbnail)): ?>
                                                        <li class="splide__slide"><img style="object-fit: contain;" class="img-thumbnail" alt="project-preview" src="<?php echo e($collections[0]->thumbnail); ?>"></li>
                                                        <?php endif; ?>
                                                        <?php
                                                            $temp = rtrim($collections[0]->imageGallery, ", ");
                                                            $temp = explode(", ", $temp);
                                    ...
                                    <div class="col-xxl-4 col-xl-5 col-lg-12 col-md-12 col-12 mt-xl-0 mt-5 align-self-center">
                                        ...
                                        <div class="product-details-content">
                                            ...
                                            <span class="badge badge-light-primary mb-3">
                                                Technopreneurship <?php echo e($collections[0]->year); ?>

                                                <?php if($collections[0]->semester == 1): ?>
                                                    Ganjil
                                                <?php else: ?>
                                                    Genap
                                                <?php endif; ?>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <h3 class="product-title mb-0"><?php echo e($collections[0]->name); ?></h3>
                                            ...
                                            <div class="action-button text-center">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xxl-12 col-xl-12 col-sm-12 mb-sm-12 mb-3">
                                                        ...
                                                        <?php else: ?>
                                                            onclick="voteNow(<?php echo e($collections[0]->id); ?>)"
                                                        <?php endif; ?>
                                ...
                                <div class="production-descriptions simple-pills">
                                    ...
                                    <div class="pro-des-content">
                                        ...
                                        <div id="iconsAccordion" class="accordion-icons accordion">
                                            ...
                                            <?php if(isset($collections[0]->livePreview) && $collections[0]->livePreview != null): ?>
                                                <div class="card" style="cursor: pointer;">
                                                    <div class="card-header bg-transparent border-0">
                                                        <a href="<?php echo e($collections[0]->livePreview); ?>" target="_blank">
                                                            <section class="mb-0 mt-0">
                                            ...
                                            <?php if(isset($collections[0]->youtube) && $collections[0]->youtube != null): ?>
                                                <div class="card" style="cursor: pointer;">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mx-2">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a href="<?php echo e($collections[0]->youtube); ?>" target="_blank">
                                            ...
                                            <?php if(isset($collections[0]->proposal) && $collections[0]->proposal != null): ?>
                                                <div class="card" style="cursor: pointer;">
                                                    ...
                                                    <div id="accordion-proposal" class="collapse" aria-labelledby="headingOne3" data-bs-parent="#iconsAccordion">
                                                        <div class="card-body">
                                                            <div class="row mx-2">
                                                                <div class="col-md-12">
                                                                        <embed type="application/pdf" class="d-md-flex d-none" src="<?php echo e($collections[0]->proposal); ?>" style="width: 100%; height: 85vh;"></embed>
                                                                        <a href="<?php echo e($collections[0]->proposal); ?>" target="_blank">
    ...
    <script src="<?php echo e(url('src/plugins/src/splide/splide.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/assets/js/apps/ecommerce-details.js')); ?>"></script>
    ...
    <script>
        function voteNow(idTeam) {
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('voteNow.post')); ?>",
                data:{
                    "_token": "<?php echo e(csrf_token()); ?>",
                    "id": "<?php echo e($collections[0]->id); ?>"
                },
...
<?php /**PATH D:\lama\Project\techno\resources\views/public/exhibition-detail.blade.php ENDPATH**/ ?>