...
<body class="">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mt-4">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Product Name" value="<?php echo e($collections->title); ?>">
                                            <input type="hidden" class="form-control" id="id" name="id" placeholder="Product Name" value="<?php echo e($collections->id); ?>">
                                        </div>
                                        ...
                                        <div class="col-6 mt-4">
                                            ...
                                            <input id="start-date-news" name="start-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="<?php echo e(gmdate("Y-m-d | H:i:s", $collections->start_date)); ?>" placeholder="Select Date..">
                                        </div>

                                        <div class="col-6 mt-4">
                                            <label for="end-date-news" class="form-label">End Date News</label>
                                            <input id="end-date-news" name="end-date-news" class="form-control flatpickr flatpickr-input active" type="text" value="<?php echo e(gmdate("Y-m-d | H:i:s", $collections->end_date)); ?>" placeholder="Select Date..">
                                        </div>

                                        <div class="form-check form-switch form-check-inline form-switch-primary col-6 mt-4">
                                            <input class="form-check-input" type="checkbox" role="switch" id="is_active"
                                            <?php if($collections->is_active == 1): ?>
                                                    checked
                                            <?php endif; ?>>
    ...
    <script>
        $(".btn-submit").click(function(e){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxNewsEdit.post')); ?>",
                data:{
                ...
                success:function(data){
                    if(data.status == 200){
                        swal({
                            ...
                            function(isConfirm) {
                            if (isConfirm) {
                                window.location.href = "<?php echo e(route('news.list')); ?>";
                            }
                        });
                    }else{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-news-edit.blade.php ENDPATH**/ ?>