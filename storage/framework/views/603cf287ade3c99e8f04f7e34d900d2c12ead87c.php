...
<head>
    ...
    <link href="<?php echo e(url('src/assets/css/dark/pages/error/error.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <div class="row">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="index.html" class="ml-md-5">
                    <img alt="image-logo" src="<?php echo e(url('/internal/logo-side-bar1.png')); ?>" class="dark-element theme-logo">
                    <img alt="image-logo" src="<?php echo e(url('/internal/logo-side-bar1.png')); ?>" class="light-element theme-logo">
                    <img alt="image-text" src="<?php echo e(url('/internal/text-universitas-petra.png')); ?>">
                </a>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\lama\Project\techno\resources\views/errors/404.blade.php ENDPATH**/ ?>