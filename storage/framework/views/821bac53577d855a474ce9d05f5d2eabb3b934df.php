...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/src/tagify/tagify.css')); ?>">
    <link href="<?php echo e(url('src/assets/css/light/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/css/light/tagify/custom-tagify.css')); ?>">

    <link href="<?php echo e(url('src/assets/css/dark/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/plugins/css/dark/tagify/custom-tagify.css')); ?>">

    <link href="<?php echo e(url('src/assets/css/light/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(url('src/plugins/css/light/editors/markdown/simplemde.min.css')); ?>">

    <link href="<?php echo e(url('src/assets/css/dark/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(url('src/plugins/css/dark/editors/markdown/simplemde.min.css')); ?>">
    ...
    <link href="<?php echo e(url('src/plugins/src/notification/snackbar/snackbar.min.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo e(url('src/assets/css/light/components/tabs.css')); ?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/light/elements/alert.css')); ?>">

    <link href="<?php echo e(url('src/plugins/css/light/sweetalerts2/custom-sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('src/plugins/css/light/notification/snackbar/custom-snackbar.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/light/forms/switches.css')); ?>">
    <link href="<?php echo e(url('src/assets/css/light/components/list-group.css')); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo e(url('src/assets/css/light/users/account-setting.css')); ?>" rel="stylesheet" type="text/css" />



    <link href="<?php echo e(url('src/plugins/css/dark/filepond/custom-filepond.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('src/assets/css/dark/components/tabs.css')); ?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/dark/elements/alert.css')); ?>">

    <link href="<?php echo e(url('src/plugins/css/dark/sweetalerts2/custom-sweetalert.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('src/plugins/css/dark/notification/snackbar/custom-snackbar.css')); ?>" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('src/assets/css/dark/forms/switches.css')); ?>">
    <link href="<?php echo e(url('src/assets/css/dark/components/list-group.css')); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo e(url('src/assets/css/dark/users/account-setting.css')); ?>" rel="stylesheet" type="text/css" />
...
<body class="">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#"><?php echo e($collection->name); ?></a></li>
                            </ol>
                        </nav>
                    </div>
                    <!-- /BREADCRUMB -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mb-3" id="name" name="name" placeholder="Type project name" value="<?php echo e($collection->name); ?>">
                                            <input type="hidden" class="form-control mb-3" id="id" name="id"  value="<?php echo e($collection->id); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mb-3" id="nrp" placeholder="type nrp leader" value="<?php echo e($collection->nrp_leader); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mb-3" id="slug" name="slug" placeholder="type slug" value="<?php echo e($collection->slug); ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex pt-3">
                                                ...
                                                <?php endif; ?>>
                                                    ...
                                                    <?php if($collection->slug != null): ?>
                                                        <?php echo e(URL::to('/exhibition/'.$collection->slug)); ?>

                                                    <?php else: ?>
                                                        <?php echo e(URL::to('/exhibition/'.$collection->id)); ?>
                                    ...
                                    <div class="col-md-12 mt-4 form-group">
                                        ...
                                        <a href="<?php echo e(route('studentListCategory')); ?>">
                                            <label>
                                                <button class="btn btn-secondary ms-3 px-3 py-1">Edit</button>
                                            </label>
                                        </a>
                                        <input id="tag" name='tag' class="border-0" value='<?php echo e(rtrim($collection->categories, ", ")); ?>' readonly>
                                    </div>
    ...
    <script src="<?php echo e(url('src/plugins/src/filepond/filepond.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginFileValidateType.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginImageExifOrientation.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginImagePreview.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginImageCrop.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginImageResize.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/FilePondPluginImageTransform.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/filepond/filepondPluginFileValidateSize.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/notification/snackbar/snackbar.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/sweetalerts2/sweetalerts2.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/assets/js/users/account-settings.js')); ?>"></script>

    <script src="<?php echo e(url('src/assets/js/scrollspyNav.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/tagify/tagify.min.js')); ?>"></script>
    <script src="<?php echo e(url('src/plugins/src/tagify/custom-tagify.js')); ?>"></script>
    ...
    <script>
        $(".btn-submit").click(function(e){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxTeamProfileEdit.post')); ?>",
                data:{
...
<?php /**PATH D:\lama\Project\techno\resources\views/student/profile.blade.php ENDPATH**/ ?>