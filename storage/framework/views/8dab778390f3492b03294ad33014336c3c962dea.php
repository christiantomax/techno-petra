...
<head>
    ...
    <title>Techno | Create Team Leader</title>
...
<body class="">
    ...
    <script type="text/javascript">
        $(".btn-submit").click(function(e){
            ...
            let data = [
                $("input[name=tag]").val(),
                $('select[name=period] option').filter(':selected').val(),
            ];
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxTeamCreate.post')); ?>",
                data:{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-team-leader-create.blade.php ENDPATH**/ ?>