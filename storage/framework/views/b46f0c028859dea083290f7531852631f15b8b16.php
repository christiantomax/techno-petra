                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($collection->news_for == 1): ?>
                                                        <?php echo e("All"); ?>

                                                    <?php elseif($collection->news_for == 2): ?>
                                                        <?php echo e("Public"); ?>

                                                    <?php else: ?>
                                                        <?php echo e("Team Leader"); ?>

                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e(gmdate("Y-m-d | H:i:s", $collection->start_date)); ?></td>
                                                <td><?php echo e(gmdate("Y-m-d | H:i:s", $collection->end_date)); ?></td>
                                                ...
                                                <?php endif; ?>
                                                <td>
                                                    <a href="<?php echo e(url('admin/news/edit')); ?>/<?php echo e($collection->id); ?>">
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-news-leader-list.blade.php ENDPATH**/ ?>