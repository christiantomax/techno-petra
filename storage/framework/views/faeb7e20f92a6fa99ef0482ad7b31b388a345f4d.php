...
<head>
    ...
    <title>Techno | Create Category</title>
...
<body class="">
    ...
    <script type="text/javascript">
        $(".btn-submit").click(function(e){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo e(route('ajaxCategoryCreate.post')); ?>",
                data:{
...
<?php /**PATH D:\lama\Project\techno\development\resources\views/admin/setting-category-create.blade.php ENDPATH**/ ?>